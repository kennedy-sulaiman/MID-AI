...
public class nqueen {
     ...
     private static final double MUTATION_RATE = 0.0001; // Mutation Rate. Range: 0.0 < MUTATION_RATE < 1.0
     private static final int MIN_SELECT = 10; // Minimum parents allowed for selection.
     private static final int MAX_SELECT = 40; // Maximum parents allowed for selection. Range: MIN_SELECT < MAX_SELECT
                                               // < START_SIZE
     ...
     private static final int MAX_LENGTH = 15; // chess board width.
     ...
     private static void rouletteSelection() {
          ...
          double genTotal = 0.0;
          double selTotal = 0.0;
          final int maximumToSelect = getRandomNumber(MIN_SELECT, MAX_SELECT);
     ...
     private static void partiallyMappedCrossover(final int chromA, final int chromB, final int child1,
               final int child2) {
          int j = 0;
          int item1 = 0;
          int item2 = 0;
          int pos1 = 0;
          int pos2 = 0;
          final Chromosome thisChromo = population.get(chromA);
          final Chromosome thatChromo = population.get(chromB);
          final Chromosome newChromo1 = population.get(child1);
          final Chromosome newChromo2 = population.get(child2);
     ...
     private static void positionBasedCrossover(final int chromA, final int chromB, final int child1,
               final int child2) {
          int k = 0;
          int numPoints = 0;
          final int tempArray1[] = new int[MAX_LENGTH];
          final int tempArray2[] = new int[MAX_LENGTH];
          ...
          final int crossPoints[] = new int[numPoints];
     ...
     private static void printbestSolution(final Chromosome bestSolution) {
          final String board[][] = new String[MAX_LENGTH][MAX_LENGTH];
     ...
     private static int getRandomNumber(final int low, final int high, final int[] except) {
          boolean done = false;
          int getRand = 0;
     ...
     private static class Chromosome {
          private final int mData[] = new int[MAX_LENGTH];
          ...
          public void conflicts(final int value) {
